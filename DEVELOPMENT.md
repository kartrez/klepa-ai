# Klepa AI Development Guide

Welcome to the Klepa AI development guide! This document will help you set up your development environment and understand how to work with the codebase. Whether you're fixing bugs, adding features, or just exploring the code, this guide will get you started.
...
1. **Fork and Clone the Repository**:
    ...
    - **Fork the Repository**:
        - Visit the [Klepa AI GitHub repository](https://github.com/Kilo-Org/kilocode)
...
2. This will open a new VSCode window with Klepa AI loaded
...
Klepa AI uses several types of tests to ensure quality:
...
- Check the Output panel in VSCode (View > Output) and select "Klepa AI" from the dropdown
- For webview issues, use the browser developer tools in the webview (right-click > "Inspect Element")

### Testing with Local Backend

To test the extension against a local Klepa AI backend:
...
We welcome contributions to Klepa AI! Here's how you can help:
