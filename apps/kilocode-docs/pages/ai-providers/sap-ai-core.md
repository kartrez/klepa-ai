...
# Using SAP AI Core With Klepa AI

Klepa AI supports accessing models through SAP AI Core, a service in the SAP Business Technology Platform that lets you efficiently run AI scenarios in a standardized, scalable, and hyperscaler-agnostic manner.
...
To use SAP AI Core with Klepa AI, you'll need to create a service key for your SAP AI Core service instance:
...
Klepa AI applies the following filters when fetching models:
...
3. Configure Klepa AI with your credentials
