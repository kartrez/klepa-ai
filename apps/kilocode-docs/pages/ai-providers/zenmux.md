...
3. **Configure in Klepa AI:** Add your API key to Klepa AI settings.
...
- Check the [Klepa AI GitHub repository](https://github.com/kilocode/kilocode) for integration-specific issues
