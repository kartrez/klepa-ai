...
The Agent Manager is a dedicated control panel for running and supervising Klepa AI agents as interactive CLI processes. It supports:
...
- Install/update the Klepa AI CLI (latest) — see [CLI setup](/docs/cli)
...
- Command Palette: “Klepa AI: Open Agent Manager”
- Or use the title/menu entry if available in your Klepa AI UI
...
1. **Klepa AI Extension (Recommended)**
...
To use the Agent Manager with all features enabled, switch to the Klepa AI provider or sign in through the extension.
...
- Remote sessions not visible
    ...
    - If using BYOK, session syncing is not available — switch to Klepa AI provider or sign in through the extension
