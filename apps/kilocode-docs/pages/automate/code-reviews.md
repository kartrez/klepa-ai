...
- **Klepa AI credits are still used** when the agent performs model reasoning during a review.

## How to Use

1. Go to the **Review Agent** section in your Klepa AI [personal](https://app.gpt-chat.by/profile) or [Organization](https://app.gpt-chat.by/organizations) dashboard.
