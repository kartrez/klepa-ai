---
title: "Automate"
description: "Automate your development workflows with Klepa AI"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend Klepa AI's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect Klepa AI to external tools and services:
...
- [**Using MCP in Klepa AI**](/docs/automate/mcp/using-in-kilo-code) — Configuration guide
...
Connect Klepa AI with your development tools:
...
Customize and extend Klepa AI's capabilities:
