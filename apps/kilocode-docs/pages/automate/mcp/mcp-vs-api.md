...
## Why Klepa AI Uses MCP

Klepa AI leverages MCP to provide:
...
MCP creates a universal connector between Klepa AI and external services, with REST APIs often powering those services behind the scenes.
