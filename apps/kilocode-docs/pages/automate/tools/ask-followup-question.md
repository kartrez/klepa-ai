...
This tool creates a conversational interface between Klepa AI and the user, allowing for gathering clarification, additional details, or user preferences when facing ambiguities or decision points. Each question can include suggested responses to streamline the interaction.

## When is it used?

- When critical information is missing from the original request
- When Klepa AI needs to choose between multiple valid implementation approaches
- When technical details or preferences are required to proceed
- When Klepa AI encounters ambiguities that need resolution
...
1. **Information Gap Recognition**: Klepa AI identifies missing information needed to proceed
2. **Specific Question Creation**: Klepa AI formulates a clear, targeted question
3. **Suggestion Development**: Klepa AI creates relevant suggested answers (optional but recommended)
...
10. **Task Continuation**: Klepa AI proceeds with the task using the new information

## Examples When Used

- When developing a web application, Klepa AI might ask about preferred styling frameworks (Bootstrap, Tailwind, custom CSS)
- When creating an API, Klepa AI might ask about authentication methods (JWT, OAuth, API keys)
- When refactoring code, Klepa AI might ask about prioritizing performance vs. readability
- When setting up a database, Klepa AI might ask about specific schema design preferences
- When creating a custom feature, Klepa AI might ask about specific behavior expectations
- When troubleshooting errors, Klepa AI might ask about specific environment details
