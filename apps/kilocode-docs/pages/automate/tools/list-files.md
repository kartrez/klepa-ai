...
The `list_files` tool displays the files and directories within a specified location. It helps Klepa AI understand your project structure and navigate your codebase effectively.
...
- When Klepa AI needs to understand your project structure
- When Klepa AI explores what files are available before reading specific ones
- When Klepa AI maps a codebase to better understand its organization
- Before using more targeted tools like `read_file` or `search_files`
- When Klepa AI needs to check for specific file types (like configuration files) across a project
...
- When starting a new task, Klepa AI may list the project files to understand its structure before diving into specific code.
- When asked to find specific types of files (like all JavaScript files), Klepa AI first lists directories to know where to look.
- When providing recommendations for code organization, Klepa AI examines the current project structure first.
- When setting up a new feature, Klepa AI lists related directories to understand the project conventions.
