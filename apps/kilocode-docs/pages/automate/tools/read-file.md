...
The `read_file` tool examines the contents of files in a project. It allows Klepa AI to understand code, configuration files, and documentation to provide better assistance.
...
- When Klepa AI needs to understand existing code structure
- When Klepa AI needs to analyze configuration files
- When Klepa AI needs to extract information from text files
- When Klepa AI needs to see code before suggesting changes
...
- When asked to explain or improve code, Klepa AI first reads the relevant files to understand the current implementation.
- When troubleshooting configuration issues, Klepa AI reads config files to identify potential problems.
- When working with documentation, Klepa AI reads existing docs to understand the current content before suggesting improvements.
