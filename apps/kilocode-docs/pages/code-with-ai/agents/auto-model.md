...
Auto Model (`kilo/auto`) is a smart model routing system that automatically selects the optimal AI model based on the Klepa AI mode you're using. It balances cost and capability so you get the best results without manual model switching.
...
Select `kilo/auto` from the model dropdown in the Klepa AI chat interface. That's all you need to do.
{% /callout %}

1. Open Klepa AI in VS Code or JetBrains
...
- **New Klepa AI users** - Great defaults without needing to understand model differences
...
- [Using Modes](/docs/code-with-ai/agents/using-modes) - Learn about different Klepa AI modes
