...
description: Learn how to use Klepa AI effectively while minimizing or eliminating costs through free models, budget-friendly alternatives, and smart usage strategies.
---

# Free and Budget Models

**Why this matters:** AI model costs can add up quickly during development. This guide shows you how to use Klepa AI effectively while minimizing or eliminating costs through free models, budget-friendly alternatives, and smart usage strategies.
...
3. Configure Klepa AI with the OpenRouter provider
...
2. **Configure multiple providers** in Klepa AI
