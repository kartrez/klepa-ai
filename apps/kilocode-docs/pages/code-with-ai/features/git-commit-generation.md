...
Generate descriptive commit messages automatically based on your staged git changes. Klepa AI analyzes your staged files and creates conventional commit messages that follow best practices.
...
2. In the VS Code Source Control panel, look for the `Klepa AI` logo next to the commit message field)
...
- [Settings Management](/docs/getting-started/settings) - Manage all your Klepa AI preferences
