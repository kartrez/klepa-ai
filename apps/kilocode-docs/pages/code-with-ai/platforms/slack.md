---
title: "Slack"
description: "Using Klepa AI in Slack"
---

# Kilo for Slack

Kilo for Slack brings the power of Klepa AI directly into your Slack workspace. Ask questions about your repositories, request code implementations, or get help with issues—all without leaving Slack.
...
- You must have a **Klepa AI account** with available credits
...
3. **AI generates a response** — Klepa AI's AI analyzes your request and provides helpful responses
...
- **Klepa AI credits are used** when Kilo performs work (model usage, operations, etc.)
- Credit usage is similar to using Klepa AI through other interfaces
