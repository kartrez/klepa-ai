...
description: "Provide custom instructions to guide Klepa AI"
---

# Custom Instructions

Custom Instructions allow you to personalize how Klepa AI behaves, providing specific guidance that shapes responses, coding style, and decision-making processes.
...
{% image src="/docs/img/custom-instructions/custom-instructions.png" alt="Klepa AI Modes tab showing global custom instructions interface" width="600" caption="Klepa AI Modes tab showing global custom instructions interface" /%}

1.  **Open Modes Tab:** Click the <Codicon name="organization" /> icon in the Klepa AI top menu bar
...
Mode-specific instructions can be set using the Modes Tab
    ...
    {% image src="/docs/img/custom-instructions/custom-instructions-3.png" alt="Klepa AI Modes tab showing mode-specific custom instructions interface" width="600" caption="Klepa AI Modes tab showing mode-specific custom instructions interface" /%}
    * **Open Tab:** Click the <Codicon name="organization" /> icon in the Klepa AI top menu bar
