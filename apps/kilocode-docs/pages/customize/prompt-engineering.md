...
Prompt engineering is the art of crafting effective instructions for AI models like Klepa AI. Well-written prompts lead to better results, fewer errors, and a more efficient workflow.

## General Principles

- **Be Clear and Specific:** Clearly state what you want Klepa AI to do. Avoid ambiguity.
...
It's often helpful to guide Klepa AI through a "think-then-do" process:

1.  **Analyze:** Ask Klepa AI to analyze the current code, identify problems, or plan the approach.
2.  **Plan:** Have Klepa AI outline the steps it will take to complete the task.
3.  **Execute:** Instruct Klepa AI to implement the plan, one step at a time.
4.  **Review:** Carefully review the results of each step before proceeding.

## Using Custom Instructions

You can provide custom instructions to further tailor Klepa AI's behavior. There are two types of custom instructions:
...
- Adjust Klepa AI's tone or personality.

See the [Custom Instructions](/docs/customize/custom-instructions) section for more details.

## Handling Ambiguity

If your request is ambiguous or lacks sufficient detail, Klepa AI might:
...
If Klepa AI doesn't produce the desired results, you can provide feedback by:

- **Rejecting Actions:** Click the "Reject" button when Klepa AI proposes an action you don't want.
- **Providing Explanations:** When rejecting, explain _why_ you're rejecting the action. This helps Klepa AI learn from its mistakes.
...
By following these tips, you can write effective prompts that get the most out of Klepa AI's capabilities.
