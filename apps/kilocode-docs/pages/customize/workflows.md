---
title: "Workflows"
description: "Create automated workflows with Klepa AI"
---

# Workflows

Workflows automate repetitive tasks by defining step-by-step instructions for Klepa AI to execute. Invoke any workflow by typing `/[workflow-name.md]` in the chat.

{% image src="/docs/img/slash-commands/workflows.png" alt="Workflows tab in Klepa AI" width="600" caption="Workflows tab in Klepa AI" /%}
...
Now you can trigger this workflow by typing `/submit-pr.md` in the chat. Klepa AI will:
