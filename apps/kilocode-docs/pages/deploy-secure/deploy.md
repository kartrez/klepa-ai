---
title: "Deploy"
description: "Deploy your applications with Klepa AI"
---

# Deploy

Kilo Deploy lets you ship **Next.js** and **static sites** directly from Klepa AI, with:

- **One-click deployment** from the Klepa AI dashboard
...
2. Click **Configure** and follow the prompts to connect GitHub to Klepa AI
