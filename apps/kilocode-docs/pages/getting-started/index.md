---
title: "Introduction to Klepa AI"
description: "Get started with Klepa AI - the leading open source agentic engineering platform"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Klepa AI is an open-source AI coding assistant that works wherever you do—in your IDE, terminal, browser, or on the go. Generate code, automate reviews, debug issues, and ship faster with AI that understands your codebase.
{% /callout %}
...
1. [Install Klepa AI](/docs/getting-started/installing) in your preferred environment
...
Klepa AI is open source. You can inspect the code, contribute features, or fork it to meet your needs.
