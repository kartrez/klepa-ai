...
As you work with Klepa AI, each task creates files containing conversation history, checkpoints, and other data. Over time, this accumulates and can consume significant disk space. Auto-Cleanup solves this by:
...
Access Auto-Cleanup settings through the Klepa AI settings panel:

1. Click the gear icon ({% codicon name="gear" /%}) in Klepa AI
