...
description: "Configure native OS notifications for Klepa AI"
---
...
Klepa AI uses system notifications to inform you about:
...
Klepa AI's system notifications work on all major operating systems with different underlying technologies:
...
No additional setup required. Klepa AI uses macOS's built-in command to display notifications.
...
**How it works:** Klepa AI first attempts to use `terminal-notifier` and automatically falls back to AppleScript if it's not installed.
