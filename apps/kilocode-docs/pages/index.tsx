...
const terminalContent = {
	installation: (
		<>
			<span className="terminal-comment"># Install Klepa AI VS Code Extension</span>
			{"\n"}
	...
	firstTask: (
		<>
			<span className="terminal-comment"># Start a new task with Klepa AI</span>
			{"\n"}
...
const categories = [
	{
		title: "Get Started",
		description: "Install Klepa AI and get up and running in minutes",
	...
	{
		title: "Code with AI",
		description: "Learn how to use Klepa AI to write, edit, and understand code",
		href: "/code-with-ai",
		icon: (
			<svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
	...
	{
		title: "Contributing",
		description: "Help improve Klepa AI and learn about its architecture",
		href: "/contributing",
		icon: (
			<svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
				<path
		...
		<div className="homepage">
			...
			<section className="hero">
				<div className="hero-content">
					<h1 className="hero-title">Klepa AI Documentation</h1>
					<p className="hero-subtitle">
						Explore our guides and examples to build with Klepa AI, the most popular open source coding
						agent.
					</p>
					<div className="hero-buttons">
						<Link href="/getting-started" className="btn btn-primary">
							Get started with Klepa AI →
						</Link>
			...
			<section className="terminal-section">
				<div className="terminal-intro">
					...
					<p className="terminal-description">Get started quickly with common Klepa AI commands</p>
				</div>
