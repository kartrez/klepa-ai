...
The Klepa AI CLI stores task history in `~/.kilocode/cli/` (or `%USERPROFILE%\.kilocode\cli\` on Windows). With heavy usage, this directory can grow significantly.
...
If you also use the Klepa AI VS Code extension, you can enable automatic task history cleanup:

1. Open VS Code Settings (`Cmd+,` / `Ctrl+,`)
2. Search for "Klepa AI auto purge"
