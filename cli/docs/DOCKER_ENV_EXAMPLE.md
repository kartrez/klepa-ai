...
This document demonstrates how to run Klepa AI CLI in a Docker container using only environment variables, without requiring a config.json file.
...
This will run Klepa AI CLI in a completely ephemeral environment without any persistent configuration files.
