...
program
	.name("kilocode")
	.description("Klepa AI Terminal User Interface - AI-powered coding assistant")
	...
	.action(async (prompt, options) => {
		...
		if (!hasConfig && !hasEnvConfig) {
			...
			console.info("Welcome to the Klepa AI CLI! 🎉\n")
		...
		logs.debug("Starting Klepa AI CLI", "Index", { options })
...
program
	.command("auth")
	.description("Manage authentication for the Klepa AI CLI")
	.action(async () => {
		await authWizard()
	})
...
program
	.command("debug")
	.description("Run a system compatibility check for the Klepa AI CLI")
