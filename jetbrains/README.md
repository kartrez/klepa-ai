...
This directory contains the JetBrains plugin implementation for Klepa AI, including both the IntelliJ plugin (Kotlin) and the Extension Host (Node.js/TypeScript).
