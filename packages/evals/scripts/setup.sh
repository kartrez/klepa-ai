...
build_extension() {
  echo "🔨 Building the Klepa AI extension..."
...
echo -n "🗄️ Syncing Klepa AI evals database... "
...
read -p "💻 Do you want to build a new version of the Klepa AI extension? [currently $current_version] (y/N): " build_extension
