...
export function getVisibleProviderOrLog(outputChannel: vscode.OutputChannel): ClineProvider | undefined {
	...
	if (!visibleProvider) {
		outputChannel.appendLine("Cannot find any visible Klepa AI instances.")
		return undefined
	}
...
export const openClineInNewTab = async ({ context, outputChannel }: Omit<RegisterCommandOptions, "provider">) => {
	...
	const newPanel = vscode.window.createWebviewPanel(ClineProvider.tabPanelId, "Klepa AI", targetCol, {
		enableScripts: true,
	...
	newPanel.iconPath = {
		light: vscode.Uri.joinPath(context.extensionUri, "assets", "icons", "icon-light.png"),
		dark: vscode.Uri.joinPath(context.extensionUri, "assets", "icons", "icon-dark.png"),
	}
