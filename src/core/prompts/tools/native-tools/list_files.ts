...
const PATH_PARAMETER_DESCRIPTION = `The path of the directory to list contents for (relative to the current workspace directory).`

const RECURSIVE_PARAMETER_DESCRIPTION = `Whether to list files recursively. Use true for recursive listing, false for top-level only.`
