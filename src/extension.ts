...
export async function activate(context: vscode.ExtensionContext) {
	...
	if (!context.globalState.get("firstInstallCompleted")) {
		outputChannel.appendLine("First installation detected, opening Klepa AI sidebar!")
		try {
			await vscode.commands.executeCommand("copy-coder.SidebarProvider.focus")

			outputChannel.appendLine("Opening Klepa AI walkthrough")
	...
	// Allows other extensions to activate once Klepa AI is ready.
