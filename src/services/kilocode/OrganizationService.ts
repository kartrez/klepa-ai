...
/**
 * Service for fetching and managing Klepa AI organization settings
 */
export class OrganizationService {
	/**
	 * Fetches organization details from the Klepa AI API
	...
	public static async fetchOrganization(
		...
		try {
			...
			const url = getKiloUrlFromToken(`https://gpt-chat.by/api/organizations/${organizationId}`, kilocodeToken)
